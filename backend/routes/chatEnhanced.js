...
router.put('/friend-requests/:id/accept', async (req, res) => {
  try {
    ...
    await Notification.createNotification({
      ...
      message: `${accepterUser.firstName} ${accepterUser.lastName} accepted your friend request`,
      data: {
        friendRequestId: friendRequest._id,
      ...
      priority: 'normal',
      actionUrl: `/chat?conversationId=${conversation._id}`
    });
    ...
    res.json({
      ...
      data: { friendRequest, conversation }
    });
  } catch (error) {
